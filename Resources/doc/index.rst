...
Composer will install the bundle to your project's ``vendor/vidoomy/notification-bundle`` directory.
...
.. code-block:: php
         ...
         public function registerBundles()
         {
            $bundles = array(
                // ...
                new Vidoomy\NotificationBundle\MgiletNotificationBundle(),
                // ...
            );
         }
...
2. Implement the ``Vidoomy\NotificationBundle\NotifiableInterface`` interface (it's an empty interface)
...
.. code-block:: php
    ...
    ...
    use Vidoomy\NotificationBundle\Annotation\Notifiable;
